...
// 
// -------------------------------------------------
// Notice: This code does not work under mootools 1.2.x any more.
// 
// Require :
// Mootools mootools-core-1.4.5-full-nocompat !
// Compatibility code changed by:
// darko.hajnal@domenacom.hr  , Darko Hajnal , Domena.com d.o.o. 2013.
	...
	initialize: function(obj, options) {
		...
		if (window.ie6) {
			this.iframe = new Element('iframe', { 
				'styles': { left: '-1000px', position: 'absolute', top: '-1000px', zIndex: 99999 }
