...
initializeWindows = function(){
	...
	$$('a.returnFalse').each(function(el){
        ...
        //
        MUI.youtubeHTML5Window = function(){
		new MUI.Window({
			id: 'youtubeHTML5Window',
			title: 'HTML5 video test',
			loadMethod: 'iframe',
			url: 'pages/youtubeHTML5.html',
			width: 505,
			height: 375,
		 	resizeLimit: {'x': [275, 2500], 'y': [125, 2000]},
                });
...
window.addEvent('load', function(){
	...
	$$('.desktopIcon').addEvent('click', function(){
        ...
        // HTML5 video test
        $('youtubeHTML5Icon').addEvent('click', function(){
		MUI.youtubeHTML5Window();
	});
...
window.addEvent('unload', function(){
	// This runs when a user leaves your page.
        MUI.notification('Closing application .....');	
});