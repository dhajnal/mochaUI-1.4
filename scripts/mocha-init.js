...
initializeWindows = function(){
	...
	if ($('jsonLink')){
        ...
        //RSS Windows
        MUI.RSSWindow1 = function(){
		new MUI.Window({
			id: 'RSSWindow1',
                        loadMethod: 'iframe',
			contentURL: 'http://rss.bild.de/bild.xml',
			width: 440,
                        height: 250,
                        x:370,y:270,
                        title:'Das Bild RSS'
        ...
        MUI.RSSWindow2 = function(){
		new MUI.Window({
			id: 'RSSWindow2',
                        loadMethod: 'iframe',
			contentURL: 'http://www.rsssearchhub.com/feeds/national-geographic-feeds/',
			width: 440,
			height: 250,
        ...
        MUI.RSSWindow3 = function(){
		new MUI.Window({
			id: 'RSSWindow3',
                        loadMethod: 'iframe',
			contentURL: 'http://www.nytimes.com/services/xml/rss/nyt/HomePage.xml',
			width: 440,
			height: 250,
                        title:'http://www.abc.net.au/services/rss/',
                        x:300,y:210
		});
	};	
	...
	$$('a.returnFalse').each(function(el) {
        ...
        // Form Window 
        MUI.formWindow = function(){
		new MUI.Window({
			id: 'formWindow',
			contentURL: 'pages/formWindow.html',
			width: 440,
			height: 550
		});
	};
		...
		onContentLoaded: function(){		
			...
			$('splitPanelLink').addEvent('click', function(e){
				...
				MUI.splitPanelPanel(); // This is initialized in mocha-init.js just like the windows.	
                        ...
                        // CK editor on main panel 
                        $('CKEditorPanelLink').addEvent('click', function(e){
				MUI.updateContent({
					element: $('mainPanel'),
			...
			$('ajaxpageLink').addEvent('click', function(e){
				MUI.ajaxpageWindow();
                        ...
                        $('ajaxRSSLink').addEvent('click', function(e){
				MUI.RSSWindow1();
                                MUI.RSSWindow2();
                                MUI.RSSWindow3();
			...
			$('fxmorpherLink').addEvent('click', function(e){
				...
				MUI.fxmorpherWindow();
                        ...
                        // Update panel link
                        $('panelLink').addEvent('click', function(e){
				MUI.updateContent({
					element: $('mainPanel'),
					url: 'pages/update_panel.html',
					title: 'Update panel content',
					padding: { top: 8, right: 8, bottom: 8, left: 8 }
				});
				...
				MUI.updateContent({
					element: $('mainPanel'),
					url: 'pages/pieChart.html',
					title: 'Canvas Pie Chart demo',
					padding: { top: 8, right: 8, bottom: 8, left: 8 }
				});
